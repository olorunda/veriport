            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                        <?php echo e(config('app.name', 'veriPort')); ?>
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php else: ?>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo e(Auth::user()->f_name); ?> <?php echo e(Auth::user()->l_name); ?> <span class="caret"></span></a>
        ...
        <div class="flex-center position-ref full-height" id="bTitle">
            <div class="content">
                <div class="title m-b-md">
                    <img alt="logo" src="<?php echo e(asset('img/veriport.png')); ?>">
                    <div class="row">
                        <div class="col-md-12">
                            <div>
                ...
                <div class="row">
                    <div class="col-md-9 col-md-offset-4">
                        <p></p>
                        <a href="http://www.snapnet.com.ng" target="_blank"><img class="img-responsive" alt="snapnet" src="<?php echo e(asset('img/snapnet.png')); ?>" style="height:40px"></a>
                    </div>
                </div>
            </div>
        </div>

        <div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px;font-weight:bold;color:black;"><img src="<?php echo e(asset('img/demo_wait.gif')); ?>" width="64" height="64" /><br>Verifing applicant...</div>
                    ...
                    <div class="panel-body">
                        <div class="col-md-5">
                            <div class="img-responsive">
                                ...
                                <img class="img-thumbnail" id="usr" alt="user-image" src="<?php echo e(asset('upload').'/'.$imge); ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div>
